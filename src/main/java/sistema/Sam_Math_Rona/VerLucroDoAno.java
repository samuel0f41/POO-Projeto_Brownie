...
public class VerLucroDoAno implements ActionListener {
    ...
    public void actionPerformed(ActionEvent e){
        ...
        JOptionPane.showMessageDialog(janelaPrincipal, "Lucro de vendas R$: " + valorTotal + " do ano "+ anoPesquisar,"Ver Lucro do Ano",JOptionPane.INFORMATION_MESSAGE,vendasTotal);
    }
