...
public class VerLucroDoMes implements ActionListener {
    ...
    public void actionPerformed(ActionEvent e){
        ...
        JOptionPane.showMessageDialog(janelaPrincipal, "Lucro de vendas R$: " + valorTotal + " no mes de"+ nomeMes,"Ver Lucro do Mês",JOptionPane.INFORMATION_MESSAGE,vendasTotal);
    }
